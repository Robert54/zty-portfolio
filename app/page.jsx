...
// // import App from "./coupled-interface/App";

// const VoiceWave = dynamic(() => import("@/components/VoiceWave"), { 
//   ssr: false,
//   loading: () => <div className="h-[90px]" /> // Placeholder to prevent layout shift
// })
...
//             <div className="w-full max-w-5xl mx-auto h-[calc(100vh-200px)]">
//               <App />
//             </div>
//           </div> */}
